  ...
  return (
    <div className="pt-20 xl:pt-24 2xl:pt-28 px-4 sm:px-6 lg:px-8 pb-2">
      ...
      >
        ...
        <div>
          <h1 className="font-display text-[36px] sm:text-[44px] leading-[1.1]" style={{ color: 'var(--navy)' }}>
            <span className="font-bold">Specialists care </span><span className="font-normal"> for every member.</span>
          </h1>
          <div className="flex items-center gap-1.5 mt-1 text-[13px]" style={{ color: 'var(--muted)' }}>
            <Link to="/" className="transition-colors" style={{ color: 'var(--teal)' }}
        ...
        {/* Right: call pill + action icons */}
        <div className="flex items-center gap-3 flex-wrap">

          {/* Call pill */}
          <div
            className="flex items-center gap-3 rounded-full px-3 py-2 bg-white border border-(--line)"
          >
            <span
