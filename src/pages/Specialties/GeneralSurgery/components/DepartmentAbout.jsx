...
const deptDoctors = doctors.filter(d => d.specialty === 'Surgery');
...
const SERVICES = [
  ...
  'Piles, fissure and fistula treatment',
  'Hydrocele, circumcision and other day-care procedures',
  'Abscess drainage, cyst and lipoma removal',
  'Second surgical opinions with honest, evidence-based advice',
];
      ...
      <div className="max-w-330 mx-auto">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-12 gap-10 xl:gap-14 lg:items-start">
          ...
          <motion.div className="lg:col-span-8" variants={fadeUp} initial="hidden" whileInView="visible" viewport={vp}>
            <img src={bannerImg} alt="General and Minimal Access Surgery at UniCare Hospitals" className="w-full rounded-2xl object-cover mb-8" style={{ aspectRatio: '4/3' }} loading="lazy" />

            <h2 className="font-display leading-[1.2] mb-4" style={{ color: 'var(--navy)', fontSize: 'clamp(24px, 3.5vw, 38px)' }}>
              Advanced surgery. Smaller incisions. Faster recovery. Closer to home.
            </h2>
            <p className="text-[15px] sm:text-[16px] leading-[1.8] mb-8" style={{ color: 'var(--muted)' }}>
              Surgery is a decision families make carefully. At Unicare, your surgical opinion comes from the hospital's own founder, a fellowship-trained minimal access surgeon who will personally evaluate, operate and follow up. Most procedures use keyhole techniques, which mean less pain, smaller scars and a quicker return to normal life.
            </p>
            ...
            <p className="text-[11px] font-bold tracking-[1.1px] uppercase mb-4" style={{ color: 'var(--teal)' }}>Our Surgeon</p>
