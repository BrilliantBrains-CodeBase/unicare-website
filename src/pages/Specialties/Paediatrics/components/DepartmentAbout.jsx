...
import pedImg from '../../../../assets/pediatric.png';
...
const SERVICES = [
  ...
  'Fever, cough, cold, and childhood infection management',
  'Growth, development and nutrition monitoring',
  'Allergy and asthma care for children',
  'School health checks and adolescent health guidance',
];
    ...
    >
      ...
      <div className="doctor-card-info" onMouseDown={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center gap-2 shrink-0 pb-4" onClick={(e) => e.stopPropagation()}>
          ...
          <a href={doc.waUrl} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
          ...
          <a href={`tel:${doc.phone}`} aria-label="Call"
            className="h-8 w-8 shrink-0 rounded-full flex items-center justify-center hover:opacity-80 cursor-pointer"
            style={{ background: 'rgba(255,255,255,0.12)' }}>
            <Phone s={12} c="#fff" />
          </a>
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-12 gap-10 xl:gap-14 lg:items-start">
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-28">
            <motion.div
              ...
              viewport={vp}
            >
              {/* Other specialties nav */}
              <div>
                <p className="text-[11px] font-bold tracking-[1.1px] uppercase mb-3" style={{ color: 'var(--teal)' }}>
                  Other Specialties
                </p>
          ...
          >
            <img
              src={pedImg}
              alt="Pediatric care at UniCare Hospitals, Kokapet"
            ...
            <h2
              className="font-display leading-[1.2] mb-4"
              style={{ color: 'var(--navy)', fontSize: 'clamp(24px, 3.5vw, 38px)' }}
            >
              A pediatrician who knows your child, right here in Kokapet.
            </h2>

            <p
              className="text-[15px] sm:text-[16px] leading-[1.8] mb-8"
              style={{ color: 'var(--muted)' }}
            >
              Unicare's pediatric team cares for children from their first hours of life through their teenage years. Two MD pediatricians, in-house diagnostics, an on-site pharmacy and a calm, child-friendly environment mean faster answers and fewer anxious drives across the city.
            </p>

            <p id="services" className="text-[11px] font-bold tracking-[1.1px] uppercase mb-4" style={{ color: 'var(--teal)' }}>
              Our Services
            </p>
            ...
            <p id="faq" className="text-[11px] font-bold tracking-[1.1px] uppercase mb-4" style={{ color: 'var(--teal)' }}>
            ...
            <div>
              {FAQS.map((faq, i) => {
                ...
                return (
                  <div
                    key={i}
                    className={i < FAQS.length - 1 ? 'mb-7.5 pb-7.5' : ''}
                    style={i < FAQS.length - 1 ? { borderBottom: '1px solid #F2F4F6' } : {}}
                  >
                    <button
                      type="button"
                    ...
                    >
                      <span className="text-[17px] font-bold leading-snug" style={{ color: 'var(--navy)' }}>
                        {faq.q}
                      </span>
                    ...
                    <AnimatePresence initial={false}>
                      {isOpen && (
                        ...
                        >
                          <p className="text-[14.5px] leading-relaxed" style={{ paddingTop: 14, color: 'var(--muted)' }}>
                            {renderAnswer(faq.a)}
                          </p>
                        </motion.div>
                      )}
            ...
            {/* Doctors */}
            <p className="text-[11px] font-bold tracking-[1.1px] uppercase mt-10 mb-4" style={{ color: 'var(--teal)' }}>
              Our Pediatricians
            </p>
